...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {a7: col, cf: contextStack, bC: problem, bL: row};
	});
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.bx, s.bL, s.a7, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			0,
			{a7: newCol, b: s.b, c: s.c, bx: newOffset, bL: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
	return function (s) {
		var _v0 = A5(_Parser_findSubString, str, s.bx, s.bL, s.a7, s.a);
		var newOffset = _v0.a;
		var newRow = _v0.b;
		var newCol = _v0.c;
		...
		return A3(
			$elm$parser$Parser$Advanced$Good,
			_Utils_cmp(s.bx, adjustedOffset) < 0,
			0,
			{a7: newCol, b: s.b, c: s.c, bx: adjustedOffset, bL: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			$elm$parser$Parser$Advanced$AddRight,
			$elm$parser$Parser$Advanced$Empty,
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bL, s.a7, x, s.b));
	});
		...
		return function (s0) {
			...
			if (_v1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3($elm$core$String$slice, s0.bx, s1.bx, s0.a),
						a),
					s1);
			}
		};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {a7: col, bC: problem, bL: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bL, p.a7, p.bC);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{a7: 1, b: _List_Nil, c: 1, bx: 0, bL: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.bx, s.bL, s.a7, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $the_sett$elm_syntax_dsl$Elm$CodeGen$function = F3(
	function (docs, sig, decl) {
		return {
			cg: $the_sett$elm_syntax_dsl$Util$nodify(decl),
			ci: $the_sett$elm_syntax_dsl$Util$nodifyMaybe(docs),
...
var $the_sett$elm_syntax_dsl$Elm$CodeGen$functionImplementation = F3(
	function (name, args, expr) {
		return {
			b5: $the_sett$elm_syntax_dsl$Util$nodifyAll(args),
			al: $the_sett$elm_syntax_dsl$Util$nodify(expr),
			cG: $the_sett$elm_syntax_dsl$Util$nodify(name)
		};
	});
var $the_sett$elm_syntax_dsl$Elm$CodeGen$signature = F2(
	function (name, annotation) {
		return {
			cG: $the_sett$elm_syntax_dsl$Util$nodify(name),
			bX: $the_sett$elm_syntax_dsl$Util$nodify(annotation)
		};
	});
...
var $author$project$Elm$makeDeclaration = function (_v0) {
	var name = _v0.a;
	var texts = _v0.b;
	if ((texts.b && (!texts.a.$)) && (!texts.b.b)) {
		...
		return A2($author$project$Elm$makeFunction, name, texts);
	}
};
var $the_sett$elm_syntax_dsl$Elm$CodeGen$file = F4(
	function (mod, imports, declarations, docs) {
		return {
			ak: docs,
			bb: declarations,
			ct: $the_sett$elm_syntax_dsl$Util$nodifyAll(imports),
			cE: $the_sett$elm_syntax_dsl$Util$nodify(mod)
		};
	});
...
var $author$project$Elm$adaptName = F2(
	function (prefix, name) {
		var adapt = function (_char) {
			return $elm$core$Char$isAlpha(_char) ? $elm$core$String$fromChar(_char) : $elm$core$String$fromList(
				_List_fromArray(
					[prefix, _char]));
		};
...
var $author$project$Elm$normalize = function (_v0) {
	var name = _v0.a;
	var texts = _v0.b;
	var normalizeParameter = function (text) {
		if (text.$ === 1) {
			var p = text.a;
			return $author$project$Text$Parameter(
				$the_sett$elm_string_case$String$Case$toCamelCaseLower(
					A2($author$project$Elm$adaptName, 'p', p)));
		} else {
			var s = text.a;
			return $author$project$Text$Static(s);
		}
	};
	return _Utils_Tuple2(
		$the_sett$elm_string_case$String$Case$toCamelCaseLower(
			A2($author$project$Elm$adaptName, 't', name)),
		A2($elm$core$List$map, normalizeParameter, texts));
};
...
var $the_sett$elm_syntax_dsl$Elm$Pretty$prettyTopLevelExpose = function (tlExpose) {
	switch (tlExpose.$) {
		...
		default:
			...
			if (_v1.$ === 1) {
				return $the_sett$elm_pretty_printer$Pretty$string(exposedType.cG);
			} else {
				return A2(
					$the_sett$elm_pretty_printer$Pretty$a,
					$the_sett$elm_pretty_printer$Pretty$string('(..)'),
					$the_sett$elm_pretty_printer$Pretty$string(exposedType.cG));
			}
	}
};
			...
			A2(
				...
				A2(
					...
					$the_sett$elm_syntax_dsl$Elm$Pretty$prettyImports(
						$the_sett$elm_syntax_dsl$Util$denodeAll(file.ct)))));
	}
};
		...
		$the_sett$elm_pretty_printer$Pretty$group(
			$the_sett$elm_pretty_printer$Pretty$lines(
				_List_fromArray(
					[
						$the_sett$elm_pretty_printer$Pretty$string(
						$the_sett$elm_syntax_dsl$Util$denode(cons.cG)),
						$the_sett$elm_pretty_printer$Pretty$lines(
						A2(
							$elm$core$List$map,
							$the_sett$elm_syntax_dsl$Elm$Pretty$prettyTypeAnnotationParens,
							$the_sett$elm_syntax_dsl$Util$denodeAll(cons.b5)))
					]))));
};
	...
	var customTypePretty = A2(
		...
		A2(
			...
			$the_sett$elm_syntax_dsl$Elm$Pretty$prettyValueConstructors(
				$the_sett$elm_syntax_dsl$Util$denodeAll(type_.ce)),
			A2(
				$the_sett$elm_pretty_printer$Pretty$a,
				$the_sett$elm_pretty_printer$Pretty$string('= '),
				A2(
					...
					$the_sett$elm_pretty_printer$Pretty$words(
						_List_fromArray(
							[
								...
								$the_sett$elm_pretty_printer$Pretty$string(
								$the_sett$elm_syntax_dsl$Util$denode(type_.cG)),
								$the_sett$elm_pretty_printer$Pretty$words(
								A2(
									$elm$core$List$map,
									$the_sett$elm_pretty_printer$Pretty$string,
	...
	return $the_sett$elm_pretty_printer$Pretty$lines(
		_List_fromArray(
			[
				...
				$the_sett$elm_syntax_dsl$Util$denodeMaybe(type_.ci)),
				customTypePretty
			]));
};
			...
			case 12:
				...
				return $the_sett$elm_pretty_printer$Pretty$words(
					A2(
						...
						A2(
							$the_sett$elm_pretty_printer$Pretty$a,
							$the_sett$elm_pretty_printer$Pretty$string(qnRef.cG),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$the_sett$elm_pretty_printer$Pretty$string(
								$the_sett$elm_syntax_dsl$Util$denode(sig.cG)),
								$the_sett$elm_pretty_printer$Pretty$string(':')
							])),
						$the_sett$elm_syntax_dsl$Elm$Pretty$prettyTypeAnnotation(
						$the_sett$elm_syntax_dsl$Util$denode(sig.bX))
					]))));
};
...
var $the_sett$elm_syntax_dsl$Elm$Pretty$prettyCaseBlock = F2(
	function (indent, caseBlock) {
		...
		var patternsPart = $the_sett$elm_syntax_dsl$Elm$Pretty$doubleLines(
			A2($elm$core$List$map, prettyCase, caseBlock.ca));
	...
	return $the_sett$elm_pretty_printer$Pretty$lines(
		_List_fromArray(
			[
				...
				$the_sett$elm_syntax_dsl$Elm$Pretty$prettyMaybe,
				$the_sett$elm_syntax_dsl$Elm$Pretty$prettyDocumentation,
				$the_sett$elm_syntax_dsl$Util$denodeMaybe(fn.ci)),
				A2(
				$the_sett$elm_syntax_dsl$Elm$Pretty$prettyMaybe,
				...
				$the_sett$elm_syntax_dsl$Util$denode(fn.cg))
			]));
};
			...
			A2(
				...
				$the_sett$elm_pretty_printer$Pretty$words(
					_List_fromArray(
						[
							$the_sett$elm_pretty_printer$Pretty$string(
							$the_sett$elm_syntax_dsl$Util$denode(impl.cG)),
							$the_sett$elm_syntax_dsl$Elm$Pretty$prettyArgs(
							$the_sett$elm_syntax_dsl$Util$denodeAll(impl.b5)),
							$the_sett$elm_pretty_printer$Pretty$string('=')
						])))));
};
	...
	return $the_sett$elm_pretty_printer$Pretty$words(
		_List_fromArray(
			[
				...
				$the_sett$elm_pretty_printer$Pretty$string(
				dirToString(
					$the_sett$elm_syntax_dsl$Util$denode(infix_.ch))),
				$the_sett$elm_pretty_printer$Pretty$string(
				...
				$the_sett$elm_pretty_printer$Pretty$string('='),
				$the_sett$elm_pretty_printer$Pretty$string(
				$the_sett$elm_syntax_dsl$Util$denode(infix_.cq))
			]));
};
...
var $the_sett$elm_syntax_dsl$Elm$Pretty$prettyTypeAlias = function (tAlias) {
	var typeAliasPretty = A2(
		...
		A2(
			$the_sett$elm_pretty_printer$Pretty$a,
			$the_sett$elm_syntax_dsl$Elm$Pretty$prettyTypeAnnotation(
				$the_sett$elm_syntax_dsl$Util$denode(tAlias.bX)),
			A2(
				$the_sett$elm_pretty_printer$Pretty$a,
				$the_sett$elm_pretty_printer$Pretty$line,
				$the_sett$elm_pretty_printer$Pretty$words(
					_List_fromArray(
						[
							...
							$the_sett$elm_pretty_printer$Pretty$string(
							$the_sett$elm_syntax_dsl$Util$denode(tAlias.cG)),
							$the_sett$elm_pretty_printer$Pretty$words(
							A2(
								$elm$core$List$map,
								$the_sett$elm_pretty_printer$Pretty$string,
	...
	return $the_sett$elm_pretty_printer$Pretty$lines(
		_List_fromArray(
			[
				...
				$the_sett$elm_syntax_dsl$Elm$Pretty$prettyMaybe,
				$the_sett$elm_syntax_dsl$Elm$Pretty$prettyDocumentation,
				$the_sett$elm_syntax_dsl$Util$denodeMaybe(tAlias.ci)),
				typeAliasPretty
			]));
};
					...
					A2(
						...
						A2(
							...
							$the_sett$elm_syntax_dsl$Elm$Pretty$prettyModule(
								$the_sett$elm_syntax_dsl$Util$denode(innerFile.cE)))))));
	});
		...
		return {
			a9: A2(
				...
				A2(
					...
					A2(
						$elm$core$List$map,
						A2($elm$core$Basics$composeR, $author$project$Elm$normalize, $author$project$Elm$makeDeclaration),
						A2(
...
var $author$project$Program$init = F2(
	function (flags, options) {
		var prependOutputDirectory = function (file) {
			return _Utils_update(
				file,
				{
					bz: A2($elm$core$List$cons, options.by, file.bz)
				});
		};
		return $elm$core$Platform$Cmd$batch(
			A2(
				$elm$core$List$map,
				A2($elm$core$Basics$composeR, prependOutputDirectory, $author$project$Program$writeFile),
				A2(
...
var $author$project$Program$Options = F2(
	function (rootElmModule, outputDirectory) {
		return {by: outputDirectory, bK: rootElmModule};
	});
...
var $dillonkearns$elm_cli_options_parser$Fuzzy$Match = F4(
	function (score, offset, length, keys) {
		return {cz: keys, cB: length, bx: offset, Q: score};
	});
...
var $dillonkearns$elm_cli_options_parser$Cli$Program$init = F2(
	function (options, flags) {
		var matchResult = A3($dillonkearns$elm_cli_options_parser$Cli$Program$run, options.cd, flags.b6, flags.c7);
		var cmd = function () {
			if (!matchResult.$) {
				...
				var msg = matchResult.a;
				return A2(options.cv, flags, msg);
			}
		}();
...
var $dillonkearns$elm_cli_options_parser$Cli$Program$stateless = function (options) {
	return $elm$core$Platform$worker(
		{
			cv: $dillonkearns$elm_cli_options_parser$Cli$Program$init(options),
			au: function (_v0) {
...
var $author$project$Program$main = $dillonkearns$elm_cli_options_parser$Cli$Program$stateless(
	{cd: $author$project$Program$programConfig, cv: $author$project$Program$init, cX: $author$project$Program$printAndExitFailure, cY: $author$project$Program$printAndExitSuccess});
					...
					return A2(
						...
						function (argv) {
							return $elm$json$Json$Decode$succeed(
								{b6: argv, az: json, c7: versionMessage});
						},
						A2(
